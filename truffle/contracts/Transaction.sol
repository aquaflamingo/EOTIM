...
contract Transaction  {
    ...
    address payable public counter_party;
    ...
    constructor(
        ...
        require(_counterparty!=address(0), "Counter party cannot be blank");
    ...
    function transferInsurer(address payable newOwner) public onlyInsurer  {
